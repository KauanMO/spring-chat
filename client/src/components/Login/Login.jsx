...
export const Login = () => {
    ...
    const Wave3 = () => {
        return <svg ref={wave_3} className={styles.wave} xmlns="http://www.w3.org/2000/svg" width="1920" height="224" viewBox="0 0 1920 224" fill="none" >
            <path d="M0 0H80C160 0 320 2.86102e-06 480 5.3C640 11 800 21 960 21.3C1120 21 1303 21.3 1468 21.3C1633 21.3 1714.5 21.3 1822.5 21.3H1920V224H1840C1760 224 1600 224 1440 224C1280 224 1120 224 960 224C800 224 640 224 480 224C320 224 160 224 80 224H0V0Z" fill="#588E9F" fillOpacity="0.79" />
        </svg >
    }
